...
<!-- ALEX  JUNE 13, 2022 -->
> [原文 https://www.learncpp.com/cpp-tutorial/partial-template-specialization/](https://www.learncpp.com/cpp-tutorial/partial-template-specialization/)
...
这节课和下节课是为想更深了解 C++ 模板的同学选读的。模板偏特化不是那么常用（但是在特殊场景下非常管用）。

> 这节后面的内容 翻译暂停，去翻译其他更多基础课程去了。
